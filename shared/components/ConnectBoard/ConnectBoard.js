...
{/* 
			<Box className='A' delayX={0} delayY={0} ref={el => itemsRef.current[0] = el} windowDimensions={windowDimensions} 
				/>
			<Box className='B' delayX={2} delayY={5} ref={el => itemsRef.current[1] = el} windowDimensions={windowDimensions} 
				/>
			<LineTo from='A' to='B'  /> */}
			{children}
		</MainWrapper>
